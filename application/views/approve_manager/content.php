	...
	<tbody>
		...
		<tr class="a-center">
            ...
            <td>
            	...
            	<?php endif; ?>
            	<?php if ($update == "Y"): ?>
            	<a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("approve_manager/update_page"); ?>', '<?php echo $data->no_paket; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
            	<?php endif; ?>
            </td>
        </tr>
        <?php
...
<div id="pager">
	...
	<div style="margin-right: 10px; float: right;">
		...
		<select name="selectOrderBy" id="selectOrderBy">
			...
			<option value="sales" <?php echo $selectedName; ?>>Nama Sales</option>
		</select>
