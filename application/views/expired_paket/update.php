...
<form id="form">
	...
	<div align="center">
		<input id="button1" type="button" value="Simpan" onclick="ajaxChange('expired_paket', 'update', '<?php echo site_url("expired_paket/update"); ?>', '<?php echo site_url("expired_paket/content"); ?>', '<?php echo site_url("expired_paket/insert_page"); ?>')" /> 
		<input id="button2" type="button" value="Kembali" onclick="loadForm('<?php echo site_url("expired_paket/insert_page"); ?>')" />
	</div>
</form>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#selectKanal").die('click').live('change', function() {
