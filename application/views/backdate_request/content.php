      ...
      <tbody>
            ...
            foreach ($all_data as $data):
                  ...
                  <tr class="a-center">
                        ...
                        <td>
                              <?php if ($read == "Y"): ?>
                                    <a href="javascript:void(0);" onclick="loadShow('<?php echo site_url("backdate_request/show_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user.png"); ?>" title="Show" width="16" height="16" /></a>
                              <?php endif; ?>
                              <?php /* if ($update == "Y"): ?>
                                <a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("request/update_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
                                <?php endif; */ ?>
                              <?php if ($delete == "Y" and $data->approve == "N"): ?>
                                    <a href="javascript:void(0);" onclick="show_dialog_delete('backdate_request', 'delete', '<?php echo site_url("backdate_request/delete"); ?>', '<?php echo site_url("backdate_request/content"); ?>', '<?php echo site_url("backdate_request/insert_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user_delete.png"); ?>" title="Delete" width="16" height="16" /></a>
                              <?php endif; ?>
                        </td>
                  </tr>
                  <?php
