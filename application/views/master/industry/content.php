<table width="100%">
	...
	<tbody>
		...
		<tr class="a-center">
            ...
            <td>
            	<?php if ($read == "Y"): ?>
            	<a href="javascript:void(0);" onclick="loadShow('<?php echo site_url("master_industry/show_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user.png"); ?>" title="Show" width="16" height="16" /></a>
            	<?php endif; ?>
            	<?php if ($update == "Y"): ?>
            	<a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("master_industry/update_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
            	<?php endif; ?>
            	<?php if ($delete == "Y"): ?>
            	<a href="javascript:void(0);" onclick="show_dialog_delete('industry', 'delete', '<?php echo site_url("master_industry/delete"); ?>', '<?php echo site_url("master_industry/content"); ?>', '<?php echo site_url("master_industry/insert_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user_delete.png"); ?>" title="Delete" width="16" height="16" /></a>
            	<?php endif; ?>
            </td>
        </tr>
        <?php
