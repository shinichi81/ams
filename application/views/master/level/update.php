                  ...
                  <table style="width: 400px;">
                        ...
                        <tbody id="level">
                              ...
                              <tr align="center">
                                    <td>&nbsp;</td>
                                    <td>Unit</td>
                                    <td><input type="checkbox" name="chkAccess" value="UNIT|C" <?php echo (isset($all_access["UNIT|C"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="UNIT|R" <?php echo (isset($all_access["UNIT|R"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="UNIT|U" <?php echo (isset($all_access["UNIT|U"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="UNIT|D" <?php echo (isset($all_access["UNIT|D"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td>&nbsp;</td>
                              </tr>
                              <tr align="center">
                                    <td>&nbsp;</td>
                              ...
                              <tr align="center">
                                    <td>&nbsp;</td>
                                    <td>Harga</td>
                                    <td><input type="checkbox" name="chkAccess" value="HARGA|C" <?php echo (isset($all_access["HARGA|C"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="HARGA|R" <?php echo (isset($all_access["HARGA|R"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="HARGA|U" <?php echo (isset($all_access["HARGA|U"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="HARGA|D" <?php echo (isset($all_access["HARGA|D"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td>&nbsp;</td>
                              </tr>
                              <tr align="center">
                                    <td>&nbsp;</td>
                              ...
                              <tr align="center">
                                    <td>&nbsp;</td>
                                    <td>Production</td>
                                    <td><input type="checkbox" name="chkAccess" value="PRODUCTION|C" <?php echo (isset($all_access["PRODUCTION|C"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="PRODUCTION|R" <?php echo (isset($all_access["PRODUCTION|R"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="PRODUCTION|U" <?php echo (isset($all_access["PRODUCTION|U"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="PRODUCTION|D" <?php echo (isset($all_access["PRODUCTION|D"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td>&nbsp;</td>
                              </tr>
                              <tr align="center">
                                    <td>&nbsp;</td>
                              ...
                              <tr align="center">
                                    ...
                                    <td>PO</td>
									<td></td>
                                    <td><input type="checkbox" name="chkAccess" value="PO|R" <?php echo (isset($all_access["PO|R"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="PO|U" <?php echo (isset($all_access["PO|U"])) ? "checked='checked'" : ""; ?> /></td>
									<td></td>
									<td></td>
                              </tr>
                              <tr align="center">
									...
									<td></td>
                                    <td><input type="checkbox" name="chkAccess" value="APPROVE_MANAGER|R" <?php echo (isset($all_access["APPROVE_MANAGER|R"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="APPROVE_MANAGER|U" <?php echo (isset($all_access["APPROVE_MANAGER|U"])) ? "checked='checked'" : ""; ?> /></td>
									<td></td>
									<td></td>
                              </tr>
                              <tr align="center">
                                    ...
                                    <td>Invoice</td>
									<td></td>
                                    <td><input type="checkbox" name="chkAccess" value="INVOICE|R" <?php echo (isset($all_access["INVOICE|R"])) ? "checked='checked'" : ""; ?> /></td>
                                    <td><input type="checkbox" name="chkAccess" value="INVOICE|U" <?php echo (isset($all_access["INVOICE|U"])) ? "checked='checked'" : ""; ?> /></td>
									<td></td>
									<td></td>
                              </tr>
                              <tr align="center">
