      ...
      <table style="width: 400px;">
            ...
            <tbody>
                  ...
                  <tr align="center">
                        <td>&nbsp;</td>
                        <td>Harga</td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["HARGA|C"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["HARGA|R"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["HARGA|U"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["HARGA|D"])) ? "checked='checked'" : ""; ?> /></td>
                        <td>&nbsp;</td>
                  </tr>
                  <tr align="center">
                        <td>&nbsp;</td>
                  ...
                  <tr align="center">
                        <td>&nbsp;</td>
                        <td>Production</td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["PRODUCTION|C"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["PRODUCTION|R"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["PRODUCTION|U"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["PRODUCTION|D"])) ? "checked='checked'" : ""; ?> /></td>
                        <td>&nbsp;</td>
                  </tr>
                  <tr align="center">
                        <td>&nbsp;</td>
                  ...
                  <tr align="center">
                        ...
                        <td>PO</td>
						<td></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["PO|R"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["PO|U"])) ? "checked='checked'" : ""; ?> /></td>
						<td></td>
						<td></td>
                  </tr>
                  <tr align="center">
						...
						<td></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["APPROVE_MANAGER|R"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["APPROVE_MANAGER|U"])) ? "checked='checked'" : ""; ?> /></td>
						<td></td>
						<td></td>
                  </tr>
                  <tr align="center">
                        ...
                        <td>Invoice</td>
						<td></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["INVOICE|R"])) ? "checked='checked'" : ""; ?> /></td>
                        <td><input type="checkbox" disabled="disabled" <?php echo (isset($all_access["INVOICE|U"])) ? "checked='checked'" : ""; ?> /></td>
						<td></td>
						<td></td>
                  </tr>
                  <tr align="center">
