<table width="100%">
      <thead>
            <tr>
                  ...
                  <th><a href="#">Product Group</a></th>
                  <th><a href="#">Position</a></th>
                  <th><a href="#">Cpm Quota</a></th>
      ...
      <tbody>
            ...
            foreach ($all_data as $data):
                  ...
                  <tr class="a-center">
                        <td><?php echo $no; ?></td>
                        <td><?php echo $data->kanal_name; ?></td>
                        <td><?php echo $data->product_group_name; ?></td>
                        <td><?php echo $data->position_name; ?></td>
                        <td><?php echo number_format($data->cpm_quota, 0, ",", "."); ?></td>
                        <td><?php echo format_date($data->create_date); ?></td>
                        <td><?php echo format_date($data->update_date); ?></td>
                        <td>
                              <?php if ($read == "Y"): ?>
                                    <a href="javascript:void(0);" onclick="loadShow('<?php echo site_url("master_cpm/show_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user.png"); ?>" title="Show" width="16" height="16" /></a>
                              <?php endif; ?>
                              <?php if ($update == "Y"): ?>
                                    <a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("master_cpm/update_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
                              <?php endif; ?>
                        </td>
                  </tr>
                  <?php
