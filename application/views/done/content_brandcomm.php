		...
		<tr class="a-center">
			...
			*/ ?>
            <td>
            	...
            	<a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("done/update_page_brandcomm"); ?>', '<?php echo $data->no_brandcomm; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
            	<?php endif; ?>           
            </td>
        </tr>
        <?php
