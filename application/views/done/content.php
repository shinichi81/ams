	...
	<tbody>
		...
		<tr class="a-center">
            ...
            */ ?>
            <td>
            	<?php if ($read == "Y"): ?>
            	<a href="javascript:void(0);" onclick="loadShow('<?php echo site_url("done/show_page"); ?>', '<?php echo $data->no_paket; ?>')"><img src="<?php echo image_path("icons/user.png"); ?>" title="Show" width="16" height="16" /></a>
            	<?php endif; ?>
            	<?php if ($update == "Y" and $data->done == "N"): ?>
            	<a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("done/update_page"); ?>', '<?php echo $data->no_paket; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
            	<?php endif; ?>
            </td>
        </tr>
        <?php
...
<div id="pager">
	...
	<div style="margin-right: 10px; float: right;">
		...
		<select name="selectOrderBy" id="selectOrderBy">
			...
			<option value="Y" <?php echo $selectedY; ?>>Sudah Done</option>
			<option value="N" <?php echo $selectedN; ?>>Belum Done</option>
