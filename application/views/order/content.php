                  ...
                  <tr class="a-center">
                        ...
                        <td>
                              ...
                              <?php if ($update == "Y" and $data->approve == "N"): ?>
                                    <a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("order/update_page"); ?>', '<?php echo $data->no_paket; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
                              <?php endif; ?>
                              <?php if ($delete == "Y" and $data->approve == "N"): ?>
                                    <a href="javascript:void(0);" onclick="show_dialog_delete('order', 'delete', '<?php echo site_url("order/delete"); ?>', '<?php echo site_url("order/content"); ?>', '<?php echo site_url("order/insert_page"); ?>', '<?php echo $data->no_paket; ?>')"><img src="<?php echo image_path("icons/user_delete.png"); ?>" title="Delete" width="16" height="16" /></a>
                              <?php endif; ?>
                              <?php if ($progress == "Y" and $data->approve == "N" and $data->done == "Y"): ?>
                                    <a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("order/progress_page"); ?>', '<?php echo $data->no_paket; ?>')"><img src="<?php echo image_path("icons/user_progress.gif"); ?>" title="Progress" width="16" height="16" /></a>
      <?php endif; ?>
                        </td>
                  </tr>
                  <?php
