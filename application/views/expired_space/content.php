	...
	<tbody>
		...
		<tr class="a-center">
            ...
            */ ?>
            <td>
            	<?php if ($read == "Y"): ?>
            	<a href="javascript:void(0);" onclick="loadShow('<?php echo site_url("expired_space/show_page"); ?>', '<?php echo $data->no_space; ?>')"><img src="<?php echo image_path("icons/user.png"); ?>" title="Show" width="16" height="16" /></a>
            	<?php endif; ?>
            	<?php if ($update == "Y"): ?>
            	<a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("expired_space/update_page"); ?>', '<?php echo $data->no_space; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
            	<?php endif; ?>
            </td>
        </tr>
        <?php
...
<div id="pager">
	...
	<div style="margin-right: 10px; float: right;">
		No space : <input type="text" name="txtSearch" id="txtSearch" value="<?php echo $no_space; ?>" />
