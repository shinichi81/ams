                  ...
                  <tr class="a-center">
                        ...
                        <td>
                              ...
                              <?php if ($update == "Y" and $data->approve == "N"): ?>
                                    <a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("approve/update_page_brandcomm"); ?>', '<?php echo $data->no_brandcomm; ?>')"><img src="<?php echo image_path("icons/user_edit.png"); ?>" title="Edit" width="16" height="16" /></a>
                              <?php elseif ($update == "Y" and $data->approve == "Y" and $data->approve_paket == "N"): ?>
                                    <a href="javascript:void(0);" onclick="show_dialog_delete('approve', 'unapprove', '<?php echo site_url("approve/unapprove_brandcomm"); ?>', '<?php echo site_url("approve/content_brandcomm"); ?>', '<?php echo site_url("approve/insert_page"); ?>', '<?php echo $data->no_brandcomm; ?>')"><img src="<?php echo image_path("icons/delete.gif"); ?>" title="Unapprove" width="16" height="16" /></a>
                              <?php endif; ?>
                        </td>
                        </td>
                  </tr>
...
<div id="pager">
      Halaman:
      <select name="selectPageBrandcomm" id="selectPage">
            <?php
