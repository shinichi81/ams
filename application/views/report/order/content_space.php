      ...
      <tbody>
            ...
            foreach ($all_data as $data):
                  ...
                  <tr class="a-center">
                         ...
                         */ ?>
                        <td><a href="javascript:void(0);" onclick="loadShow('<?php echo site_url("order_space/show_page"); ?>', '<?php echo $data->no_space; ?>')"><img src="<?php echo image_path("icons/user.png"); ?>" title="Show" width="16" height="16" /></a></td>
                  </tr>
                  <?php
                  $no += 1;
            endforeach;
