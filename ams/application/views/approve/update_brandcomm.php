      ...
      <form id="form">
            <fieldset id="personal">
                  ...
                  <div style="float: left; width: 400px;">
                        ...
                        <div class='error' id='errApproveBrandcomm'></div>
                  </div>
            ...
            <div align="center">
                  <input id="button1" type="button" value="Approve" onclick="ajaxChange('approve_brandcomm', 'update', '<?php echo site_url("approve/update_brandcomm"); ?>', '<?php echo site_url("approve/content_brandcomm"); ?>', '<?php echo site_url("approve/insert_page"); ?>')" /> 
