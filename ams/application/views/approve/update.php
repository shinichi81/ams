                        ...
                        <tbody id="addme">
                              <?php foreach ($all_detail as $detail): ?>
                                    <tr class='remove'>
                                          ...
                                          <td align="center">
                                                <?php
                                                if (($detail["approve"] == "N" and $all_data->approve == "N") or ($detail["approve"] == "Y" and $all_data->approve == "Y")):
                                                      if (empty($detail["no_po"])):
                                                            ?>
                                                            <input type="text" name="txtNoPo" style="width: 110px;" rel="<?php echo $detail["id"]; ?>" value="<?php echo $detail["no_po"]; ?>" />
                                                      <?php else: ?>
                                                            <input type="text" disabled="disabled" style="width: 110px;" value="<?php echo $detail["no_po"]; ?>" />
                                                      <?php
                                                      endif;
                                                endif;
                                                ?>
