                        ...
                        <tbody id="addme">
                              ...
                              foreach ($all_detail as $detail):
                                    ...
                                    <tr class='remove'>
										  ...
										  <td align="center">
											<input type='number' name='price_deal' style='width:70px;' value='<?php echo $detail->price_deal?>'>
										  </td>
										  <td align="center">
											<input type='number' name='price_position' style='width:70px;' value='<?php echo $detail->price_position?>'>
										  </td>
                                          <td align='center'>
