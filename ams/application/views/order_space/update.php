<?php if ($update == "Y"): ?>
      ...
      <form id="form">
                        ...
                        <tbody id="addme">
                              ...
                              foreach ($all_detail as $detail):
                                    ...
                                    <tr class='remove'>
                                          ...
                                          <td align='center'>
                                                <textarea name='txtMiscInfoSpace' id='txtMiscInfoSpace' style='height: 30px; width: 130px;'><?php echo $detail->misc_info; ?></textarea>
                                          </td>
                                          <td align='center'>
            ...
            <div align="center">
                  <input id="button1" type="button" value="Simpan" onclick="ajaxChange('orderspace', 'update', '<?php echo site_url("order_space/update"); ?>', '<?php echo site_url("order_space/content"); ?>', '<?php echo site_url("order_space/insert_page"); ?>')" /> 
