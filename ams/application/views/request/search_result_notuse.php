...
<tr class="a-center">
	...
	<td>
		...
		<a href="javascript:void(0);" onclick="loadForm('<?php echo site_url("request/insert_request_page/"); ?>', '<?php echo $data->no_paket; ?>')"><img src="<?php echo image_path("icons/user_select.png"); ?>" title="Pilih" width="16" height="16" /></a>
	</td>
</tr>
<?php
	$no += 1; 
