		...
		<tr class="a-center">
            ...
            */ ?>
            <td>
            	...
            	<?php endif;*/ ?>
            	<?php if ($delete == "Y" and (empty($data->date_monitor) or $data->date_monitor == "0000-00-00 00:00:00")): ?>
            	<a href="javascript:void(0);" onclick="show_dialog_delete('request', 'delete', '<?php echo site_url("request/delete"); ?>', '<?php echo site_url("request/content"); ?>', '<?php echo site_url("request/insert_page"); ?>', '<?php echo $data->id; ?>')"><img src="<?php echo image_path("icons/user_delete.png"); ?>" title="Delete" width="16" height="16" /></a>
            	<?php endif; ?>
            </td>
        </tr>
        <?php
