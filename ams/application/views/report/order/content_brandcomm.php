<a href="<?php echo site_url("report_order_ae/excel/".$type."/".$ae."/".$start_date."/".$end_date); ?>" class="right pr_12 mt_25m" >
...
<table width="100%">
	<thead>
		<tr>
        	...
        	<?php /* <th><a href="#">Total Paket</a></th> 
        	<th><a href="#">Done</a></th>
	...
	<tbody>
		...
		<tr class="a-center">
        	...
        	<?php /* <td><?php echo $data->total_paket; ?></td> 
			...
			*/ ?>
            <td><a href="javascript:void(0);" onclick="loadShow('<?php echo site_url("brandcomm/show_page"); ?>', '<?php echo $data->no_brandcomm; ?>')"><img src="<?php echo image_path("icons/user.png"); ?>" title="Show" width="16" height="16" /></a></td>
        </tr>
        <?php
        	$no += 1; 
		endforeach;
