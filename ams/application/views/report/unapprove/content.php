<a href="<?php echo site_url("report_unapprove/excel/" . $start_date . "/" . $end_date); ?>" class="right pr_12 mt_25m" >
...
<table width="100%">
      <thead>
            <tr>
                  ...
                  <th><a href="#">Tanggal Unapprove</a></th>
      ...
      <tbody>
            ...
            foreach ($all_data as $data):
                  ...
                  <tr class="a-center">
                        <td><?php echo $no; ?></td>
                        <td><?php echo format_date($data->unapprove_date, TRUE); ?></td>
