...
class Order_Model extends CI_Model {
      ...
      public function getDetail($no_paket) {
            try {
                  $this->db->select("ads_id, kanal_id, product_group_id, position_id, misc_info, cpm_quota, price_deal, price_position");
      ...
      public function insertOrderPaketAds($no_paket, $ads_id, $kanal_id, $product_group_id, $position_id, $start_date, $end_date, $misc_info, $cpm_quota, $price_deal, $price_position) {
            try {
