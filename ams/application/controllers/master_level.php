...
class Master_Level extends CI_Controller {
      ...
      private function _getMenu($menu) {
            $result = "";
            $arrMenu = array("CALENDAR", "CLIENT", "AGENCY", "LEVEL", "DEPARTMENT", "USER", "IKLAN", "KANAL", "POSISI", "PRODUKGRUP", "CATEGORYINDUSTRY", "INDUSTRY", "CONFLICTBRAND", "MASTERBRANDCOMM", "CPM", "PAKET", "SPACE", "APPROVE", "ORDER_RECEIVE", "BRANDCOMM", "TIMELINE", "REQUEST", "RECEIVE", "REPORT_OCCUPANCY", "REPORT_ORDER", "REPORT_CLOSING", "REPORT_EXPIRED", "REPORT_UNAPPROVE", "OFFER_POSITION", "BACKDATE_REQUEST", "BACKDATE_RECEIVE");
